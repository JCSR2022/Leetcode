class Solution:
    def countOfAtoms(self, formula: str) -> str:
        ...
        # divide and conquer:
        # 1 . a stackof the  "()" so can replace the interior of a parentsis with the ans of the op
        
        #2 hasmap of elements 
        
        #pointer of parentesis 
        
        
        #from discuss, cant do it today
